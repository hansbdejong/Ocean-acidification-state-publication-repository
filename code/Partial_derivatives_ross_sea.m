...
A = xlsread('Delta_Omega_Hydrocasts');
DIC = A(:,4);
TA = A(:,5);
sal = A(:,6);
temp = A(:,7);
...
output_DIC_plus = CO2SYS(TA,DIC_1,1,2,sal,temp,temp,0,0,0,0,1,4,1);
output_TA_plus = CO2SYS(TA_1,DIC,1,2,sal,temp,temp,0,0,0,0,1,4,1);
output_sal_plus = CO2SYS(TA,DIC,1,2,sal_1,temp,temp,0,0,0,0,1,4,1);
output_temp_plus = CO2SYS(TA,DIC,1,2,sal,temp_1,temp_1,0,0,0,0,1,4,1);
